...
- (IBAction)numberPlayingCardsSliderChanged
{
    [self setLabel:self.numberPlayingCardsLabel forSlider:self.numberPlayingCardsSlider];
    self.settings.numberPlayingCards = [self.numberPlayingCardsLabel.text intValue];
}
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.numberPlayingCardsSlider.value = self.settings.numberPlayingCards;
